          ...
          <Grid item xs={12} md={6}>
            ...
            >
              <Box width={{ sx: "100%", md: "80%" }} position={"relative"}>
                <img
                  src="https://i.seadn.io/gae/aMMR2KXGtRL_jqpS6l1pLoLwUArlwKH9oEnZw-ezBoSANzRGKdManYxuzlB_kztn5bcEQA2Bgx9JWhdEQKLbgj0aFbhC7yFmMS7txw?auto=format&w=3840"
                  alt=""
                  width={"100%"}
                  ...
                  <Box display={"flex"} justifyContent="center" width={"100%"}>
                    ...
                    >
                      <Box
                        ...
                        gap={2}
                      >
                        <Typography variant="h6">0.25 ETH</Typography>
                        {/* <Box>
                          <Typography
                            sx={{
                              background:
